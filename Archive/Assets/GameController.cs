...
public class GameController : MonoBehaviour
{
    ...
    public TMP_Text correctAnswerText; // Text to show the correct answer
    ...
    private void Start()
    {
        ...
        InitializeQuestions();
        SetupUI();
        currentLevel = PlayerPrefs.GetInt("SelectedLevel", 1); // Get the selected level from PlayerPrefs
    ...
    private void SetupUI()
    {
        ...
        correctAnswerText.gameObject.SetActive(false); // Hide the correct answer text at the start
    ...
    // Load the questions based on selected level
    ...
    private void EvaluateAnswer(object userAnswer, object correctAnswer)
    {
        ...
        // Show the correct answer if the answer is wrong
        if (!isCorrect)
        {
    ...
    private IEnumerator NextAfterDelay()
    {
        ...
        answerFeedback.text = "";
        correctAnswerText.gameObject.SetActive(false); // Hide the correct answer text for next question
        inputField.text = "";
        inputField.gameObject.SetActive(false);
        NextQuestion();
    }
    ...
    private void EndGame()
    {
        ...
        correctAnswerText.gameObject.SetActive(false); // Hide the correct answer text on game over
